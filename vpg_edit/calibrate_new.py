...
checkerboard_offset_from_tool = [0.0345,-0.0272,0]
# tool_orientation = [0.7553714251817671, -1.7301571284887491, -1.7270800925902896] 
tool_orientation = [1.2309841027750899, -1.6417700286074282, -2.0187284668064036] #DEFINED AND MEASURED ORIENTATION
start_point = [-0.112,0.3168935073624113, 0.05] #DEFINED AND MESURED POINT 
...
b_perpendicular = start_point[1]-a_perpendicular*start_point[0]
num_step_face2 = 3
step_face2 = (0.03-start_point[0])/num_step_face2
...
for i in range(num_step_face2+1):
    x_initial[i] = start_point[0] + i*step_face2
