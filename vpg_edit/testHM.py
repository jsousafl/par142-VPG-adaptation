...
rtc_port = 30003
workspace_limits = np.asarray([[-0.112, 0.112], [0.18,0.404], [0.005, 0.15]]) # Cols: min max, Rows: u v z (define workspace limits in alternative coordinates)
...
#        target_position = target_position[0:3,0]
        ...
        robot.push(target_position,0,workspace_limits)
