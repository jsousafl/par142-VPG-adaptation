...
rtc_port = 30003
workspace_limits = np.asarray([[-0.27, 0.24], [0.13,0.4], [-0.002, 0.15]]) # Cols: min max, Rows: u v z (define workspace limits in alternative coordinates)
...
#        target_position = target_position[0:3,0]
        ...
        robot.grasp(target_position,0.0,workspace_limits)
