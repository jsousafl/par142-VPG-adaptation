...
class RobotiqScript(URScript):
    ...
    def _rq_is_object_detected(self):
    	gOBJ = self._rq_get_var(OBJ, 1)
    	if(self._is_OBJ_object_detected(gOBJ)):
    		#rq_obj_detect = 1
    		return True
    	else:
    		#rq_obj_detect = 0
    ...
    def _is_OBJ_object_detected (list_of_bytes):
...
class Robotiq_Two_Finger_Gripper(object):
    ...
    def get_status_obj(self):
        ...
        return urscript._rq_is_object_detected()
