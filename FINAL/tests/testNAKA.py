...
calib_grid_x = intercala(calib_grid_x[:int(num_calib_grid_pts/2)], calib_grid_x[int(num_calib_grid_pts/2):])
calib_grid_y = intercala(calib_grid_y[:int(num_calib_grid_pts/2)], calib_grid_y[int(num_calib_grid_pts/2):])
...
for i in range(2):
   ...
   robot.move_joints(joint_config2)"""
    ...
    #robot.move_to(tool_position,tool_orie