...
class Robot(object):
    ...
    def get_urx_data(self,subpackage):
        if subpackage == 'cartesian_info':
            ...
            return 0
        """elif subpackage == 'tool_data':
            false_rob = urx.Robot(self.tcp_host_ip)
            tool_analog_input2 = false_rob.get_analog_in(2,wait=True) #WE HAVE TO VERIFY THAT THE GRIPPER IS CONNECTED TO THIS ENTRY
            false_rob.close()"""            
